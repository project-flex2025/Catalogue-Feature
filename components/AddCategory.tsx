...
export default function AddCategory({open,setOpen,lastRecordId}:any) {
...
const [search, setSearch] = React.useState("");
                      ...
                      "data": [
                        {
                          ...
                          "feature_name": "Product Categories",
                          "added_by": "flex_admin",
  ...
  return (
    <React.Fragment>
      ...
      <Typography sx={{textAlign:"center",fontSize:"18px",mb:2}}>Add Categorey</Typography>
      <input
              type="text"
            ...
            <Button onClick={handleSubmit} variant='contained' size='small' sx={{mt:2}}>Submit</Button>
